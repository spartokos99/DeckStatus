...
window.addEventListener('appmodechange',event=>mode(event.detail));window.addEventListener('languagechange',()=>{if(last)render(last);});mode(await appReady);setInterval(poll,1000);
