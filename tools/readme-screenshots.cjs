...
withBrowser((req,res,url)=>{
  ...
  if(url.pathname==='/api/prolink/settings'){res.setHeader('Content-Type','application/json');res.end(JSON.stringify({autoConnect:true,devices:[{player:1,deck:1,name:'CDJ-3000'},{player:2,deck:2,name:'CDJ-3000'}]}));return true;}
